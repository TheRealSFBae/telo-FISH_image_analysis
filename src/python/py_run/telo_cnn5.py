...
with open(annotations_filename , "rb") as annotations_file:
    ...
    for line in reader:
        out_path = image_dir+line['Folder names']+"/"+line['Folder names']+"_(c2+c3+c4).JPG"
        ...
        if not os.path.isfile(out_path):
            filename = image_dir+line['Folder names']+"/"+line['Folder names']+"_(c2+c3+c4).TIF"
